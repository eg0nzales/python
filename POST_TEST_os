...
survey_id_1 = "selfserve/53b/250302"  # OS Core survey
survey_id_2 = "selfserve/53b/250303"  # OS Custom survey
...
def download_survey_data(survey_id, survey_type):
    ...
    if response.status_code == 200:
        ...
        try:
            ...
            csv_file_name = f"{test_directory}/Decipher.{year_month}.{survey_type}.TEST{test_date}.OVERSAMPLE.dat"
...
try:
    core_df, core_csv_file = download_survey_data(survey_id_1, "Core OS")
    custom_df, custom_csv_file = download_survey_data(survey_id_2, "Custom OS")
