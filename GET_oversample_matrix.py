...
survey_id = "selfserve/53b/250200"  # Core OS survey
...
def create_status_matrix(df, vendor_mapping, status_lookup):
    ...
    #matrix = matrix[['Prodege', 'SSI', 'Cint']]
    
    return matrix

# Function to save the matrix to a CSV file
def save_matrix(matrix, filename):
    output_path = os.path.join(r"T:\MarketInsights\HCMG2008\Kinesis\Incidence Reports\2. Performance Tracker\OS Matrix", filename)
...
if __name__ == "__main__":
    ...
    if df is not None:
        ...
        save_matrix(matrix, "02.2025_status_vendor_matrix.csv")
